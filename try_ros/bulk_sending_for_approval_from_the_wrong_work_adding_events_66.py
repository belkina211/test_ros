...
try:
    ...
    cancel_button.click()
    no_button=browser.find_element_by_xpath("//div[contains(@class,'btn-group')]//div[2]")
    no_button.click()
    time.sleep(5)
    ...
    work_status = browser.find_element_by_xpath('/html/body/div[1]/div[2]/div[1]/div[1]/div[2]/div/div[1]/div[2]') 
