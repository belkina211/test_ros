...
try:
    ...
    con_button = browser.find_element_by_id("proBtn_199")
    con_button.click()
    time.sleep(15)    

    browser.get(url_event)
    time.sleep(10)
    confirmation_status= browser.find_element_by_class_name("status__text") 
    confirmation_text = confirmation_status.text
    assert confirmation_text=="Согласовано","Неверный текст кнопки"
