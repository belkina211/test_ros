...
try:
    ...
    ure_radio.click()
    time.sleep(3)
    close_button = browser.find_element_by_xpath("/html/body/div[3]/div/div[3]/div/div/div")
    close_button.click()
    time.sleep(3)
    ...
    #Распределяем УРЭ
    ure_button = browser.find_element_by_xpath("/html/body/div[1]/div[2]/div[2]/div/div[1]/div[4]/span") 
    ure_button.click()
    time.sleep(5)
    ...
    send_for_approval_status = browser.find_element_by_xpath('/html/body/div[1]/div[2]/div[1]/div[1]/div[2]/div/div[1]/div[2]')
    send_for_approval_status_text=send_for_approval_status.text
    assert send_for_approval_status_text=="На согласовании","Неверный текст кнопки"
