...
try:
    ...
    #останавливаем
    stop_button = browser.find_element_by_xpath('/html/body/div[1]/div[2]/div[1]/div[2]/div[2]/div/div[2]')
    stop_button.click()
    time.sleep(3)
    ...
    #проверяем статус
    stop_status = browser.find_element_by_xpath('/html/body/div[1]/div[2]/div[1]/div[1]/div[2]/div/div[1]/div[2]') 
    stop_text=stop_status.text
    assert stop_text=="Остановлено","Неверный текст кнопки"
