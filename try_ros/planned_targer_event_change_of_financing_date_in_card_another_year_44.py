...
try:
    ...
    finansYear_combo = browser.find_element_by_xpath("/html/body/div[3]/div/div[2]/div[1]/div[2]/div/div")
    time.sleep(5)
    ...
    finansMon_combo= browser.find_element_by_xpath("/html/body/div[3]/div/div[2]/div[2]/div[2]/div/div")
    time.sleep(3)
    ...
    effectMon_combo = browser.find_element_by_xpath('/html/body/div[1]/div[2]/div[2]/div/div[2]/div[1]/form/div[2]/div/div[5]/div[2]')
    ...
    assert (endingMon_combo_text=="Январь"),"Неверный текст"
