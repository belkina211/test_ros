...
try:
    ...
    browser.get(url_event)
    send_to_draft_button = browser.find_element_by_xpath('/html/body/div[1]/div[2]/div[1]/div[2]/div[2]/div/div[1]')
    send_to_draft_button.click()
    time.sleep(5)
    yes_button= browser.find_element_by_xpath('/html/body/div[3]/div/div[3]/div/div/div[1]')
    yes_button.click()
    time.sleep(5)
    ...
    assert return_to_work_status_text=="Черновик","Неверный текст кнопки"
