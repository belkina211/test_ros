...
try:
    ...
    #Отправляем мероприятие массового на расмотрение
    agreement_button = browser.find_element_by_id("btnSendToReviewAll")
    ...
    assert approval_status_text=="На рассмотрении","Неверный текст кнопки"
