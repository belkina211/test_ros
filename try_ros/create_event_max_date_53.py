...
try:
    ...
    year_2025 = browser.find_element_by_id("FinansYear2025")
    time.sleep(5)
    year_2025.click()
    time.sleep(5)
    finansYear_combo.click()

    #устаналиваем начала финансирвоания на декабрь
    ...
    #Провереям статус
    draft_status = browser.find_element_by_xpath('/html/body/div[1]/div[2]/div[1]/div[1]/div[2]/div/div[1]/div[2]')
    draft_status_text=draft_status.text
    assert draft_status_text=="Черновик","Неверный текст кнопки"
