...
try:
    ...
    #проверяем статус
    send_to_review_status = browser.find_element_by_xpath('/html/body/div[1]/div[2]/div[1]/div[1]/div[2]/div/div[1]/div[2]') 
    send_to_review_status_text=send_to_review_status.text
    assert send_to_review_status_text=="На рассмотрении","Неверный текст кнопки"
