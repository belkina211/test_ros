...
try:
    ...
    odo_button = browser.find_element_by_id("proBtn_189")
    odo_button.click()
    time.sleep(15)    

    browser.get(url_event)
    time.sleep(10)
    approbation_status= browser.find_element_by_class_name("status__text") 
    approbation_text = approbation_status.text
    assert approbation_text=="Одобрено","Неверный текст кнопки"
