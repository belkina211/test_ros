...
try:
    ...
    no_send_for_approval = browser.find_element_by_xpath("//div[contains(@class,'visible')]//div[contains(@class,'popup__main')]")
    no_send_for_approval_text=no_send_for_approval.text
    assert no_send_for_approval_text=="Имеются несохраненные плановые данные","Неверный текст"        
