...
try:
    ...
    time.sleep(3)
    impactOnUREPlan_button = browser.find_element_by_id("ImpactOnUREPlan")
    impactOnUREPlan_button.click()
    time.sleep(15)
    ...
    assert (name_page_text=="ВЛИЯНИЕ НА УРЭ"),"Неверный текст кнопки"
