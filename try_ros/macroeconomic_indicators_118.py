...
try:
    ...
    time.sleep(3)
    repMacroeconomicFactors_button = browser.find_element_by_id("RepMacroeconomicFactors")
    repMacroeconomicFactors_button.click()
    time.sleep(15)
    ...
    assert (name_page_text=="МАКРОЭКОНОМИЧЕСКИЕ ПОКАЗАТЕЛИ"),"Неверный текст кнопки"
