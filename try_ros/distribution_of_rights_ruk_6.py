...
try:
    ...
    actionsRG_button = browser.find_element_by_id("ActionsRG") #раздел "Мероприятия на согласовании (РГ)"
    actionsOnCompletion_button = browser.find_element_by_id("ActionsOnCompletion") #раздел "Мероприятия на доработку"
    performActionsOnCompletion_button = browser.find_element_by_id("PerformActionsOnCompletion") #раздел "Исполнения мероприятий на доработке"
