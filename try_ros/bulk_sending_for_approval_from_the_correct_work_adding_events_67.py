...
try:
    ...
    #Отправляем мероприятие массового на согласование 
    agreement_button = browser.find_element_by_id("btnSendToAgreement")
    agreement_button.click()
    time.sleep(5)

    yes_button=browser.find_element_by_xpath("//div[contains(@class,'popup--confirm visible')]//div[contains(@class,'btn-group')]//div[1]")
    yes_button.click()
    time.sleep(10)
    ...
    time.sleep(10)
    approval_status = browser.find_element_by_xpath('/html/body/div[1]/div[2]/div[1]/div[1]/div[2]/div/div[1]/div[2]') 
    approval_status_text=approval_status.text
    assert approval_status_text=="На согласовании","Неверный текст кнопки"
