...
try:
    ...
    cel_radio = browser.find_element_by_xpath("/html/body/div[3]/div/div[2]/div[2]/div/label[2]")
    cel_radio.click()
    time.sleep(3)
    ...
    #меняем год начала полчения эффекта
    effectYear_combo = browser.find_element_by_xpath("/html/body/div[3]/div/div[2]/div[1]/div[2]/div/div")
    time.sleep(5)
    effectYear_combo.click()
    year_2021 = browser.find_element_by_id("Year2021")
    time.sleep(5)
    year_2021.click()
    time.sleep(5)
    effectYear_combo.click()

    #устаналиваем получения эффекта на февраль
    effectMon_combo= browser.find_element_by_xpath("/html/body/div[3]/div/div[2]/div[2]/div[2]/div/div")
    time.sleep(3)
    ...
    #Провереям, что дата окончания поменялась 
    endingMon_combo = browser.find_element_by_xpath('/html/body/div[1]/div[2]/div[2]/div/div[2]/div[1]/form/div[2]/div/div[5]/div[2]')
