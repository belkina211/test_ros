...
try:
    ...
    #снимаем с всего отметку
    unmark_button = browser.find_element_by_id("UncheckAll")
    unmark_button.click()
    time.sleep(3)
    yes_button= browser.find_element_by_xpath('/html[1]/body[1]/div[2]/div[1]/div[3]/div[1]/div[1]/div[1]')
    yes_button.click()
    time.sleep(3)
