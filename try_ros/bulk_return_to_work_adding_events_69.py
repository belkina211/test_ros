...
try:
    ...
    #Возвращаем в работу
    agreement_button = browser.find_element_by_id("btnBackToWorkAll")
    ...
    time.sleep(10)
    work_status=browser.find_element_by_xpath('/html/body/div[1]/div[2]/div[1]/div[1]/div[2]/div/div[2]/div[2]') 
